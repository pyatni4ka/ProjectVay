...
- в `Настройки` добавлены:
  ...
  - гранулярное удаление локальных данных (инвентарь/список покупок/приложение целиком) со сбросом настроек;
...
- в Плане Питания добавлена замена блюд по принципу «лучше под КБЖУ» (генерация альтернатив даже без наличия в инвентаре).
- добавлен умный Список Покупок с ручным вводом и режимом сканера `Отметка` для мгновенного штрихкод-вычёркивания купленного.
