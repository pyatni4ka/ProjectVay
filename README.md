...
- Адаптивное меню по фактическому потреблению калорий:
  - чтение `dietaryEnergyConsumed` из Apple Health (данные, внесённые в Yazio);
  - пересчёт дневной цели и генерация меню с учётом уже съеденных калорий.
